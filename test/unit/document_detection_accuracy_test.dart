...
void main() {
  ...
  const cases = <DetectionCase>[
    (
      ...
      texture: 0, background: 110, falloff: 0.18,
      corners: [Offset(38, 26), Offset(202, 26), Offset(202, 154), Offset(38, 154)],
    ),
    (
      name: 'slight tilt',
      texture: 0, background: 110, falloff: 0.18,
      corners: [Offset(40, 30), Offset(200, 20), Offset(206, 150), Offset(44, 160)],
    ),
    (
      name: 'perspective (leaning back)',
      texture: 0, background: 110, falloff: 0.2,
      corners: [Offset(58, 22), Offset(186, 30), Offset(210, 158), Offset(32, 150)],
    ),
    (
      name: 'page fills the frame',
      texture: 0, background: 110, falloff: 0.18,
      corners: [Offset(12, 10), Offset(228, 12), Offset(230, 170), Offset(10, 168)],
    ),
    (
      name: 'textured desk',
      texture: 9, background: 120, falloff: 0.18,
      corners: [Offset(40, 28), Offset(200, 26), Offset(202, 152), Offset(38, 155)],
    ),
    (
      name: 'light desk, modest contrast',
      texture: 0, background: 195, falloff: 0.10,
      corners: [Offset(42, 30), Offset(198, 28), Offset(200, 150), Offset(40, 152)],
    ),
    (
      name: 'very low contrast',
      texture: 0, background: 185, falloff: 0.15,
      corners: [Offset(42, 30), Offset(198, 28), Offset(200, 150), Offset(40, 152)],
    ),
    (
      name: 'dense body text',
      texture: 0, background: 115, falloff: 0.18,
      corners: [Offset(36, 24), Offset(204, 26), Offset(206, 156), Offset(34, 154)],
    ),
    (
      name: 'strong shadow falloff',
      texture: 0, background: 105, falloff: 0.45,
      corners: [Offset(44, 26), Offset(196, 30), Offset(198, 154), Offset(42, 150)],
    ),
    (
      name: 'rotated ~12 degrees',
      texture: 0, background: 110, falloff: 0.18,
      corners: [Offset(58, 20), Offset(210, 52), Offset(184, 162), Offset(32, 130)],
    ),
    (
      name: 'small page in frame',
      texture: 0, background: 110, falloff: 0.18,
      corners: [Offset(80, 60), Offset(165, 58), Offset(167, 125), Offset(78, 127)],
    ),
    (
      name: 'dark desk, bright page',
      texture: 4, background: 55, falloff: 0.2,
      corners: [Offset(40, 28), Offset(200, 30), Offset(203, 153), Offset(37, 151)],
    ),
  ];
  ...
  group('DocumentQuadDetector accuracy', () {
    ...
    test('does not claim high confidence when the page runs off frame', () {
      ...
      final scene = buildScene(
        corners: const [
          Offset(30, -14), Offset(205, -8), Offset(210, 140), Offset(26, 146),
        ],
        backgroundTexture: 3,
